Reame file for Trochilidae Repository on GitHub
...
5. output
	MAXENT outputs for each species and scenario.
6. raw_eBird
	Raw eBird data used for this project.
7. raw_GBIF
	Raw GBIF data used for this project.
8. results
	The thresholded and reprojected MAXENT results are located in subrepositories herein.